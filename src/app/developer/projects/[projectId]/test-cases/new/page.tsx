...
export default function NewTestCasePage({ params }: { params: Promise<{ projectId: string }> }) {
  ...
  return (
    <div className="p-8 max-w-4xl mx-auto">
      <div className="mb-6">
        <Link href={`/developer/projects/${projectId}/test-cases`} className="inline-flex items-center text-sm font-medium text-slate-500 hover:text-indigo-600 transition-colors">
